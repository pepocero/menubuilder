    ...
    <div className="stock-modal-overlay" onClick={onClose}>
      <div className="stock-modal asset-manager-modal" onClick={(e) => e.stopPropagation()}>
        <header className="stock-modal-header">
          <h2>Mis archivos</h2>
          <button type="button" className="close-btn" onClick={onClose} disabled={!!deletingId}>
            ✕
          </button>
        </header>
        ...
        <div className="asset-manager-body">
          <p className="asset-manager-hint">
            Archivos de imagen subidos a tu cuenta. Al eliminarlos se quitan de R2 y de la base de
            datos.
          </p>
        ...
        <footer className="asset-manager-footer">
          <button type="button" className="btn-secondary" onClick={() => void loadAssets()} disabled={loading || !!deletingId}>
            Actualizar
          </button>
          <button type="button" className="btn-secondary" onClick={onClose} disabled={!!deletingId}>
            Cerrar
          </button>
        </footer>
      </div>
